...
@entry_yml = "#{board}.yml"
@search_path  = (Pathname.new(File.dirname(__FILE__)).realpath + '../records_twister/').to_s
...
create_twister_pipefile_from_config(config: merged_data, board_name: board_name,
    board_info: board_info, template: "../template/Jenkinsfile_twister_template",
    output_path: "../pipe_file_twister/",)
