...
#   "lpcxpresso55s69_cpu1"  => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "kernel3", "kernel4"],
    ...
    "mimxrt1060_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",  "traffic", "samples2", "kernel", "kernel2", "kernel3", "kernel4", "usb"],
    ...
    "mimxrt595_evk_cm33" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "samples2", "kernel", "kernel2", "kernel3", "kernel4", "usb"],
