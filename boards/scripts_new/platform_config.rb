...
def platforms()
    platforms_config = {
    "frdm_kl25z" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "frdm_k64f" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",
        "sensors", "shield", "bt1", "bt2", "can", "socket", "traffic",
        "samples2", "kernel", "kernel2", "usb"],
#    "frdm_k32l2b3" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "frdm_k22f" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
#    "frdm_kl46z" => ["", "2", "3", "drivers", "kernel", "kernel2"],
    "frdm_k82f" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "frdm_kw41z" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "kernel", "kernel2"],
    "lpcxpresso54114_m0" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",  "kernel", "kernel2"],
    "lpcxpresso54114_m4" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",  "kernel", "kernel2"],
    "lpcxpresso55s69_cpu0"  => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
#   "lpcxpresso55s69_cpu1"  => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "lpcxpresso55s69_ns"  => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "lpcxpresso55s16_ns" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "lpcxpresso55s28_ns" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "lpcxpresso55s28"    => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    "mimxrt1010_evk" => ["", "2", "3", "4", "5", "cmsis","drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1015_evk" => ["", "2", "3", "4", "5", "cmsis","drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1020_evk" => ["", "2", "3", "4", "5", "cmsis","drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1024_evk" => ["", "2", "3", "4", "5", "cmsis","drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1050_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "sensors", "shield", "traffic",
        "bt1", "bt2", "can", "socket", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1060_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",  "traffic", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1064_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples",  "traffic",
        "sensors", "shield", "bt1", "bt2", "can", "socket", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt685_evk_cm33" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "twr_ke18f" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "kernel", "kernel2"],
    "twr_kv58f220m" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "kernel", "kernel2"],
    "mimx8mm_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "samples2", "kernel", "kernel2"],
    }
