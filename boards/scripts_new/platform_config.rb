...
#    "frdm_kl46z" => ["", "2", "3", "drivers", "kernel", "kernel2"],
    ...
    "frdm_kw41z" => ["", "2", "3", "4", "5", "drivers", "samples", "kernel", "kernel2"],
...
#    "lpcxpresso55s69_cpu1"  => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2"],
    ...
    "mimxrt1010_evk" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1015_evk" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1020_evk" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt1050_evk" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "sensors", "shield",
    ...
    "mimxrt1064_evk" => ["", "2", "3", "4", "5", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "mimxrt685_evk_cm33" => ["", "2", "3", "4", "5", "cmsis", "drivers", "samples", "samples2", "kernel", "kernel2", "usb"],
    "twr_ke18f" => ["", "2", "3", "4", "5", "drivers", "samples", "kernel", "kernel2"],
