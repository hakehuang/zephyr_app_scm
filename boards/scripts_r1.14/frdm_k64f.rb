...
@entry_yml = "#{board}.yml"
@search_path  = (Pathname.new(File.dirname(__FILE__)).realpath + '../records_r1.14.1/').to_s
...
create_pipefile_from_config(config: merged_data, board_name: board.gsub("_samples", ""))
create_report_from_config(config: merged_data, board_name: board.gsub("_samples", ""))
